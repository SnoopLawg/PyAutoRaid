...
def AutoCB(xCB, yCB):
    ...
    while pyautogui.locateOnScreen(r"assets\demonLord.png", confidence=0.9) != None:
        demonLordx, demonLordy = pyautogui.locateCenterOnScreen(
            r"assets\demonLord.png", confidence=0.8
        )
    ...
    while pyautogui.locateOnScreen(r"assets\demonLord2.png", confidence=0.9) != None:
        demonLord2x, demonLord2y = pyautogui.locateCenterOnScreen(
            r"assets\demonLord2.png", confidence=0.8
        )
    ...
    while pyautogui.locateOnScreen(r"assets\CBreward.png", confidence=0.8) != None:
        CBrewardx, CBrewardy = pyautogui.locateCenterOnScreen(
            r"assets\CBreward.png", confidence=0.8
        )
        time.sleep(2)
    ...
    while pyautogui.locateOnScreen(r"assets\CBhard.png", confidence=0.8) != None:
        ...
        while pyautogui.locateOnScreen(r"assets\CBbattle.png", confidence=0.8) != None:
            CBbattlex, CBbattley = pyautogui.locateCenterOnScreen(
                r"assets\CBbattle.png", confidence=0.8
            )
            time.sleep(2)
    ...
    while pyautogui.locateOnScreen(r"assets\CBstart.png", confidence=0.8) != None:
        CBstartx, CBstarty = pyautogui.locateCenterOnScreen(
            r"assets\CBstart.png", confidence=0.8
        )
        time.sleep(2)
        ...
        time.sleep(1)
        while (
            pyautogui.locateOnScreen(r"assets\CBcontinue.png", confidence=0.8) != None
        ):
            CBcontinuex, CBcontinuey = pyautogui.locateCenterOnScreen(
                r"assets\CBcontinue.png", confidence=0.8
            )
            time.sleep(2)
        ...
        while (
            pyautogui.locateOnScreen(r"assets\gotoBastion.png", confidence=0.8) == None
        ):
            while (
                pyautogui.locateOnScreen(r"assets\CBcrashed.png", confidence=0.8)
                != None
            ):
                quitAll()
                with open("log.txt", mode="a") as file:
                ...
                sys.exit()
            while (
                pyautogui.locateOnScreen(r"assets\CBcrashed2.png", confidence=0.8)
                != None
            ):
                quitAll()
                with open("log.txt", mode="a") as file:
                ...
                sys.exit()
            while (
                pyautogui.locateOnScreen(r"assets\gotoBastion.png", confidence=0.8)
                != None
            ):
                gotoBastionx, gotoBastiony = pyautogui.locateCenterOnScreen(
                    r"assets\gotoBastion.png", confidence=0.8
                )
                with open("log.txt", mode="a") as file:
                    file.write("\n finished CB battle")
