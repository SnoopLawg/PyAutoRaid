// GENERATED from direction_b.jsx by tools/build_dashboard.mjs — do not edit; edit the .jsx and rebuild.
...
function DirectionB() {
  ...
  const [sec, setSec] = React.useState(() => {
    try {
      return localStorage.getItem('par_b_section') || 'overview';
    } catch (e) {
      return 'overview';
    }
  });
  React.useEffect(() => {
    try {
      localStorage.setItem('par_b_section', sec);
    } catch (e) {}
  }, [sec]);
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "pyautoraid")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10.5,
      color: 'var(--text-dim)',
      marginTop: 6
    ...
    className: "mono"
  }, "v2.1-beta \xB7 ", s.account.name)), /*#__PURE__*/React.createElement("nav", {
    className: "scroll",
    style: {
      padding: '8px 6px',
      display: 'flex',
  ...
  }, B_NAV.map(n => /*#__PURE__*/React.createElement("a", {
    key: n.id,
    href: "#",
    onClick: e => {
      e.preventDefault();
  ...
  }, /*#__PURE__*/React.createElement("span", null, n.label), /*#__PURE__*/React.createElement("span", {
    className: "mono",
    style: {
      fontSize: 10,
      color: 'var(--text-dim)'
    }
  }, n.hint)))), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '10px 12px',
    ...
    className: `dot ${running ? 'run' : 'ok'}`
  }), /*#__PURE__*/React.createElement("span", {
    className: "mono",
    style: {
      color: running ? 'var(--accent)' : 'var(--text-sub)',
    ...
    className: "mono"
  }, doneCount, "/", s.tasks.length, " tasks \xB7 ", pct, "%"), /*#__PURE__*/React.createElement("button", {
  ...
  }, running ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(SvgIcon.pause, null), " Pause") : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(SvgIcon.play, null), " Start run")))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, secMeta?.label), /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--text-dim)',
      fontSize: 11
    }
  ...
  }, /*#__PURE__*/React.createElement(StripMetric, {
    label: "Lv",
    val: s.account.level,
    accent: true
  }), /*#__PURE__*/React.createElement(StripMetric, {
    label: "Power",
    val: fmt(s.account.power, 'power')
  }), /*#__PURE__*/React.createElement(Sep, null), /*#__PURE__*/React.createElement(StripMetric, {
    icon: "energy",
    ...
    icon: "arena",
    val: s.resources.arena_tokens.toFixed(1)
  }), /*#__PURE__*/React.createElement(StripMetric, {
    icon: "cb",
    val: `${s.resources.cb_keys}/2`
  }), /*#__PURE__*/React.createElement(Sep, null), /*#__PURE__*/React.createElement(SuperRaidWidget, {
    size: "sm"
  ...
  }, s.vm.host, " \xB7 ", Math.round(s.vm.cpu), "% \xB7 ", s.vm.ram.toFixed(1), "G"))), /*#__PURE__*/React.createElement("div", {
    className: "scroll page-body",
    style: {
      overflowY: 'auto',
      overflowX: 'hidden',
      padding: 12,
  ...
  }, sec === 'overview' && /*#__PURE__*/React.createElement(PageOverview, {
    s: s,
    pct: pct,
    doneCount: doneCount,
    activeTask: activeTask,
    running: running
  }), sec === 'live' && /*#__PURE__*/React.createElement(PageLive, {
    s: s,
    pct: pct,
    doneCount: doneCount,
    activeTask: activeTask,
    running: running
  }), sec === 'tasks' && /*#__PURE__*/React.createElement(PageTasks, {
    s: s
  }), sec === 'resources' && /*#__PURE__*/React.createElement(PageResources, {
    s: s
  }), sec === 'cb' && /*#__PURE__*/React.createElement(PageCB, {
    s: s
  }), sec === 'dungeons' && /*#__PURE__*/React.createElement(PageDungeons, {
    s: s
  }), sec === 'heroes' && /*#__PURE__*/React.createElement(PageHeroes, {
    s: s
  }), sec === 'champs' && /*#__PURE__*/React.createElement(PageChampManager, null), sec === 'events' && /*#__PURE__*/React.createElement(PageEvents, {
    s: s
  }), sec === 'history' && /*#__PURE__*/React.createElement(PageHistory, {
    s: s
  }), sec === 'mod' && /*#__PURE__*/React.createElement(PageMod, {
    s: s
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      borderTop: '1px solid var(--border)',
  ...
  }, "stdout \xB7 HybridController.log"), /*#__PURE__*/React.createElement("span", {
    style: {
      flex: 1
    }
  }), /*#__PURE__*/React.createElement("span", {
  ...
  }, s.log.length, " lines \xB7 tail -f")), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      minHeight: 0
    }
  }, /*#__PURE__*/React.createElement(LogFeed, {
    limit: 40,
    theme: "B"
  })))));
}
...
function PanelTaskQueue({
  ...
  }, done, "/", s.tasks.length), /*#__PURE__*/React.createElement("button", {
  ...
  }, s.running ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(SvgIcon.pause, null), " Pause") : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(SvgIcon.play, null), " Run ", selectedCount < s.tasks.length ? `(${selectedCount})` : '')));
  return /*#__PURE__*/React.createElement("div", {
    className: "card",
    style: {
      padding: 0,
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, t.status === 'done' && /*#__PURE__*/React.createElement(SvgIcon.check, null), t.status === 'running' && /*#__PURE__*/React.createElement("div", {
      style: {
        width: 4,
        height: 4,
        background: 'var(--accent)',
    ...
    }), t.status === 'skipped' && /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 10,
        color: 'var(--text-dim)',
        lineHeight: 1
      }
    }, "-"), pendingSelected && /*#__PURE__*/React.createElement(SvgIcon.check, {
      style: {
        color: 'var(--accent)',
        opacity: 0.85
      }
    ...
    }, t.status === 'running' ? `${(t.ms / 1000).toFixed(1)}s / ${(t.duration / 1000).toFixed(1)}s` : `${(t.duration / 1000).toFixed(1)}s`))), t.status === 'running' && /*#__PURE__*/React.createElement("div", {
      style: {
        width: 40,
        height: 3,
        borderRadius: 2,
      ...
      style: {
        height: '100%',
        width: `${Math.min(100, t.ms / t.duration * 100)}%`,
        background: 'var(--accent)'
      }
    })));
  })));
}
function PanelActiveTask({
  s,
  activeTask,
  running,
  doneCount,
  ...
  }, activeTask && running ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10.5,
      color: 'var(--text-dim)',
      letterSpacing: '0.04em',
...
function PanelLayers({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    }, "\u25CF ", L.latency, "ms")), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11.5,
        marginTop: 4
      }
...
function PanelEvents({
  ...
  }, s.events.map(e => /*#__PURE__*/React.createElement("div", {
    key: e.name,
    style: {
      marginBottom: 10,
      opacity: e.upcoming ? 0.5 : 1
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
  ...
  }, e.reward), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 3,
      background: 'var(--bg-subtle)',
      borderRadius: 2,
...
function PanelCB({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    title: "clan boss \xB7 ultra-nightmare",
    right: s.cb.clan
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 14
    ...
    className: "num"
  }, s.cb.damage_today ? (s.cb.damage_today / 1e6).toFixed(1) : '—'), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: 'var(--text-sub)'
    }
  }, "M dmg today"), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1
    }
  }), /*#__PURE__*/React.createElement("div", {
    ...
    className: "mono"
  }, s.resources.cb_keys, "/2 keys")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'end',
      gap: 4,
  ...
  }, s.cb.history.map(h => /*#__PURE__*/React.createElement("div", {
    key: h.day,
    style: {
      flex: 1,
      display: 'flex',
...
function PanelResources({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    icon: 'sacrifice',
    label: 'mystery shards',
    val: s.resources.shards.mystery
...
function PanelArena({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, s.arena_opponents.slice(0, 4).map(o => /*#__PURE__*/React.createElement("div", {
    key: o.name,
    style: {
      padding: '5px 6px',
      borderRadius: 4,
  ...
  }, o.pick && /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--ok)'
    }
  }, "\u25C6"), /*#__PURE__*/React.createElement("span", {
    ...
    style: {
      fontSize: 10.5,
      color: o.status === 'weak' ? 'var(--ok)' : o.status === 'strong' ? 'var(--danger)' : 'var(--text-dim)'
    }
  }, (o.power / 1e6).toFixed(2), "M"))))));
}
function HistoryChartB({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    y2: P + t * (H - 2 * P),
    stroke: "var(--border)"
  })), line(d => d.silver_m, maxSilver, 'var(--violet)'), line(d => d.cb_dmg_m, maxCB, 'oklch(0.82 0.17 85)'), line(d => d.gems, maxGems, 'var(--accent)'), data.map((d, i) => i % 2 === 0 && /*#__PURE__*/React.createElement("text", {
    key: d.day,
    x: xs[i],
    y: H + 12,
    fontSize: "9",
